...
export default function Hero({ onContactClick }) {
  const words = ['CSE Student', 'Web Developer', 'AI Enthusiast'];
  ...
  return (
    <section id="home" className="section hero-full-screen" aria-label="Hero Welcome Section">
      <div className="hero-container">
        <div className="hero-left">
          {/* Staggered entrance element 1 */}
          <div className="hero-status-pill entrance-fade delay-1">
            <span className="status-dot"></span>
            <span>Open for Internships & AI/Web Projects</span>
          </div>

          {/* Staggered entrance element 2 */}
          <h1 className="hero-title entrance-fade delay-2">
            Hi, I'm <span className="gradient-text">Gokulnath</span>
          </h1>

          {/* Staggered entrance element 3 - Typewriter Subtitle */}
          <div className="hero-typing entrance-fade delay-3">
            <span className="typing-text">{currentText}</span>
            <span className="cursor-blink">|</span>
          </div>

          {/* Staggered entrance element 4 - Short intro */}
          <p className="hero-desc entrance-fade delay-4">
            3rd-Year Computer Science Student building modern, performant, and intelligent web software and AI-powered tools.
          </p>

          {/* Staggered entrance element 5 - Action CTAs */}
          <div className="hero-cta entrance-fade delay-5">
            <a className="btn-primary hero-btn-primary" href="#projects" onClick={scrollToProjects}>
              View Projects
            ...
            <a className="btn-ghost hero-btn-ghost" href={`${import.meta.env.BASE_URL}resume.pdf`} download="Gokulnath_Resume.pdf">
              Download Resume 📥
            </a>

            <button className="btn-ghost hero-btn-ghost" onClick={onContactClick}>
              Contact Me
            </button>
          </div>

          {/* Staggered entrance element 6 - Location & Info */}
          <div className="hero-meta entrance-fade delay-6">
            <span>📍 <strong>Bhavani, Tamil Nadu, India</strong></span>
            <span className="dot-divider">•</span>
            <span>🎓 <strong>Shanmugha College of Engineering</strong></span>
          </div>

          {/* Staggered entrance element 7 - Social Links */}
          <div className="social-links entrance-fade delay-7">
        ...
        <div className="hero-right entrance-fade delay-4">
      ...
      <a href="#about" className="scroll-down-indicator" onClick={(e) => {
        e.preventDefault();
